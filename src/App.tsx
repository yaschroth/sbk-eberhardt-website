/**
 * SBK Eberhardt - Schädlingsbekämpfung Website
...
// ============================================
// BUSINESS CONFIGURATION - SBK Eberhardt
// ============================================
const CONFIG = {
  companyName: 'SBK Eberhardt',
  companyNameFull: 'SBK Eberhardt Schädlings\u00ADbekämpfung',
  companyLegalName: 'SBK Eberhardt - Kay Eberhardt',
  tagline: 'sauber. zuverlässig. nachhaltig.',
  phone: '0172/75 71 0 56',
  phoneLink: 'tel:+4917275710056',
  whatsapp: '4917275710056',
  email: 'info@sbk-eberhardt.de',
  address: 'Max-Eyth-Straße 23, 71254 Ditzingen',
  region: 'Ditzingen & Region Stuttgart',
  yearsExperience: '15',
...
const PROCESS_STEPS = [
  ...
  { step: '4', title: 'Lösung', description: 'Nachhaltige Bekämpfung mit umweltschonenden Methoden.' },
];

const FAQ_ITEMS = [
  { q: 'Was kostet eine Schädlingsbekämpfung?', a: 'Die Kosten variieren je nach Art und Umfang des Befalls. Wir erstellen Ihnen ein transparentes, faires Angebot.' },
  { q: 'Arbeiten Sie nachhaltig?', a: 'Ja, Nachhaltigkeit ist uns wichtig. Wir setzen auf umweltschonende Methoden und vermeiden unnötige Chemie.' },
  { q: 'In welchen Regionen sind Sie tätig?', a: 'Wir betreuen die Region Stuttgart mit über 40 Gemeinden, darunter Ditzingen, Gerlingen, Korntal-Münchingen und viele mehr.' },
  { q: 'Bieten Sie auch Katzenschutznetze an?', a: 'Ja, wir montieren professionelle Schutznetze für Balkone und Terrassen, um Ihre Katzen zu schützen.' },
];

const TESTIMONIALS = [
  { name: 'Familie Weber', location: 'Ditzingen', text: 'Herr Eberhardt hat unser Wespenproblem schnell und sauber gelöst. Sehr professionell und freundlich!', rating: 5 },
  { name: 'Thomas K.', location: 'Stuttgart', text: 'Top Service bei der Rattenbekämpfung. Zuverlässig, nachhaltig und faire Preise. Sehr empfehlenswert!', rating: 5 },
  { name: 'Pension Müller', location: 'Gerlingen', text: 'Seit Jahren unser Partner für die Schädlingsprävention. Immer pünktlich und gründlich.', rating: 5 },
];

const CERTIFICATIONS = [
  { name: 'Nachhaltig', label: 'Umweltschonend' },
  { name: 'Zuverlässig', label: 'Termingerecht' },
  { name: 'Sauber', label: 'Professionell' },
  { name: 'Regional', label: '40+ Gemeinden' },
];

const SERVICE_AREAS = ['Ditzingen', 'Stuttgart', 'Gerlingen', 'Korntal-Münchingen', 'Leonberg', 'Ludwigsburg', 'Feuerbach', 'Vaihingen'];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-lime-100 selection:text-lime-900">
      {/* Top Emergency Bar */}
      <div className="bg-brand-primary text-white py-2 px-4 text-center text-sm font-medium">
        <div className="container mx-auto flex justify-center items-center gap-4 flex-wrap">
          ...
          <a href={CONFIG.phoneLink} className="flex items-center gap-1 hover:underline text-brand-accent font-bold">
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-2 bg-brand-accent hover:bg-brand-highlight text-brand-primary px-4 py-2 rounded-full text-sm font-bold transition-colors shadow-lg shadow-lime-200"
            >
      ...
      <section className="relative pt-12 pb-24 lg:pt-20 lg:pb-32 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={CONFIG.phoneLink} className="bg-brand-accent hover:bg-brand-highlight text-brand-primary px-8 py-4 rounded-xl font-bold text-lg transition-colors shadow-xl shadow-lime-100 flex items-center justify-center gap-2 group">
              ...
              <div className="mt-10 flex items-center gap-6 flex-wrap">
                <div className="flex items-center gap-2">
                  <Leaf className="text-brand-accent size-5" />
                  <span className="text-sm font-semibold text-slate-700">Nachhaltige Methoden</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="text-brand-accent size-5" />
                  <span className="text-sm font-semibold text-slate-700">40+ Gemeinden</span>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/5] lg:aspect-square">
                ...
                <div className="absolute bottom-6 left-6 right-6 glass-card p-6 rounded-2xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-xs font-bold text-brand-accent uppercase tracking-wider">Umweltschonend</p>
                      <p className="text-brand-primary font-bold">Nachhaltige Bekämpfung</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-6 -right-6 bg-white p-4 rounded-2xl shadow-lg hidden sm:block">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold">Umweltschonend</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="absolute top-0 right-0 w-1/3 h-full bg-lime-50/50 -skew-x-12 translate-x-1/2 -z-10" />
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {SERVICES.map((service, idx) => (
              ...
              >
                ...
                <div className="mb-6 bg-lime-100 w-16 h-16 rounded-2xl flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {PROCESS_STEPS.map((item, idx) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 bg-brand-accent text-brand-primary rounded-full text-2xl font-bold mb-6">
                  {item.step}
                </div>
                {idx < 3 && (
                  <div className="hidden md:block absolute top-8 left-[60%] w-[80%] h-0.5 bg-lime-200" />
                )}
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 bg-brand-accent text-brand-primary p-8 rounded-3xl shadow-xl max-w-xs hidden sm:block">
            ...
            <div>
              ...
              <div className="space-y-6 text-slate-600 leading-relaxed">
                <p>
                  Als erfahrener Schädlingsbekämpfer in der Region Stuttgart steht SBK Eberhardt für professionelle, saubere und nachhaltige Lösungen bei allen Schädlingsproblemen.
                </p>
                <p>
                  Unser Einsatzgebiet umfasst über 40 Gemeinden rund um Stuttgart. Wir setzen auf umweltschonende Methoden und beraten Sie gerne zu präventiven Maßnahmen.
                </p>
                <div className="grid grid-cols-2 gap-6 pt-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-brand-primary font-bold">Nachhaltig</p>
                      <p className="text-xs">Umweltschonend</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="size-10 bg-lime-100 rounded-full flex items-center justify-center font-bold text-lime-700">
                    {t.name[0]}
                  </div>
                  <div>
              ...
              {FAQ_ITEMS.map((item, idx) => (
                ...
                >
                  <h4 className="font-bold text-brand-primary mb-2 flex items-start gap-3">
                    <span className="bg-lime-100 text-brand-accent rounded-full w-6 h-6 flex items-center justify-center text-sm flex-shrink-0 mt-0.5">?</span>
                    {item.q}
                  </h4>
          ...
          <div className="max-w-5xl mx-auto bg-brand-primary rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row">
            <div className="p-12 lg:w-1/2 text-white">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <Phone className="size-6 text-brand-accent" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <Mail className="size-6 text-brand-accent" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <MapPin className="size-6 text-brand-accent" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <Clock className="size-6 text-brand-accent" />
                  </div>
                  <div>
              ...
              <div className="mt-12 p-6 bg-brand-accent/20 rounded-2xl border border-brand-accent/30">
                <p className="text-brand-accent font-bold mb-2 flex items-center gap-2">
                  <Leaf className="size-5" /> Nachhaltige Methoden
                </p>
                <p className="text-sm text-slate-300">
                  Wir setzen auf umweltschonende Verfahren für Ihre Sicherheit und die Natur.
                </p>
              </div>
            </div>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:border-brand-accent focus:ring-0 transition-colors outline-none appearance-none">
                    ...
                    <option>Katzenschutznetz</option>
                ...
                <button className="w-full bg-brand-accent hover:bg-brand-highlight text-brand-primary py-4 rounded-xl font-bold text-lg transition-colors shadow-lg shadow-lime-100">
                  Anfrage senden
                </button>
              </form>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2">
              ...
              <div className="flex gap-4">
                <a href={`https://wa.me/${CONFIG.whatsapp}`} aria-label="WhatsApp" className="size-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-brand-accent hover:text-brand-primary transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent">
                  <MessageCircle className="size-5" />
                </a>
                <a href={CONFIG.phoneLink} aria-label="Anrufen" className="size-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-brand-accent hover:text-brand-primary transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent">
                  <Phone className="size-5" />
                </a>
                <a href={`mailto:${CONFIG.email}`} aria-label="E-Mail" className="size-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-brand-accent hover:text-brand-primary transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                <li><a href="#services" className="hover:text-brand-accent transition-colors">Privatkunden</a></li>
                <li><a href="#services" className="hover:text-brand-accent transition-colors">Gewerbekunden</a></li>
                <li><a href="#services" className="hover:text-brand-accent transition-colors">Katzenschutznetze</a></li>
                <li><a href="#services" className="hover:text-brand-accent transition-colors">Prävention</a></li>
              </ul>
            </div>
      ...
      <a
        href={`https://wa.me/${CONFIG.whatsapp}`}
        className="fixed bottom-6 right-6 z-50 sm:hidden bg-brand-accent text-brand-primary p-4 rounded-full shadow-2xl motion-safe:animate-bounce"
